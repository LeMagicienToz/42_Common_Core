...
/*   Updated: 2024/07/18 18:31:51 by mconreau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
/*
...
main(void)
{
	...
	send(socket, "\n");
	::usleep(10);
	send(socket, "abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\r\n");
	::usleep(10);
	send(socket, "0\r\n\r\n");
